...
public class ResponseMessage {
	 ...
	 * 
	 * @param type
	 *            Message type. Cannot be <code>null</code>.
	 */
	 ...
	 *            Message type. Cannot be <code>null</code>.
	 * @param platform
	 *            Platform type. If <code>null</code> then default value will be
	 *            used
	 */
	...
	public static enum MessageType {
		...
		private static Map<Integer, MessageType> typeByCode = new HashMap<Integer, MessageType>();
		private static Map<String, MessageType> typeByName = new HashMap<String, MessageType>();
	...
	public enum Platform {
		DEFAULT(null), GOOGLE("google"), FACEBOOK("facebook"), SLACK("slack"), TELEGRAM("telegram"), KIK("kik"), VIBER(
				"viber"), SKYPE("skype"), LINE("line");
		...
		private static Map<String, Platform> platformByName = new HashMap<String, Platform>();
	...
	/**
	 * <a href=
	 * "https://docs.api.ai/docs/query#section-text-response-message-object">
	 * Text response</a> message object
	 */
	...
	/**
	 * <a href="https://docs.api.ai/docs/query#section-card-message-object">Card
	 * message</a> object
	 */
	...
	/**
	 * <a href=
	 * "https://docs.api.ai/docs/query#section-quick-replies-message-object">
	 * Quick replies</a> message object
	 */
	public static class ResponseQuickReply extends ResponseMessage {
		...
		/**
		 * Set quick replies title. Required for the Facebook Messenger, Kik,
		...
		/**
		 * Get quick replies title. Required for the Facebook Messenger, Kik,
		 * and Telegram one-click integrations.
		 */
		public String getTitle() {
			return this.title;
	...
	/**
	 * <a href="https://docs.api.ai/docs/query#section-image-message-object">
	 * Image</a> message object
	 */
	...
	/**
	 * <a href="">Custom payload</a> message object that holds an object passed
